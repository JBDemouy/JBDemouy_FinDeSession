...
fichier = "twitter_journalistes.csv"
...
"@cyblesoleil","@Lactualite","@coupdepouce_mag","@la_lesaffaires","@journalmetro","@icircpremiere", "@RNCNouvellesAT", "@OFF_TLMEP",
"@icirctele", "@icitoutv"]
...
"@mdiplo", "@Mediapart", "@RTLFrance", "@franceinfo", "@lejdd", "@RTenfrançais", "@19HRuthElkrief"]
...
# hashtags = ["#merdias", "#journalope", "#merdia", "#journaldegauche", "#fakenews", "#radiopoubelle",
# "#bonjournalisme", "#presselibre", "#freepress"]

medias = quebecMedia + franceMedia
journalistes = quebecJournalistes + franceJournalistes

# print(medias)

# tweets = t.GetSearch(term = media,count = 500,result_type = "recent", lang = "fr", return_json = True)
for i in reversed(range(15,28)):


	# for media in medias:
	for journaliste in journalistes:
		tweets = t.GetSearch(term = journaliste,count = 500,result_type = "recent", lang = "fr", since="2019-03-{}".format(i-1),until="2019-03-{}".format(i), return_json = True)
